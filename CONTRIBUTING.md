# Contributing to ChipOS

Help us build the definitive knowledge and task management engine for AI coding assistants! This guide shows you how to contribute new features, bug fixes, and improvements to the ChipOS platform.

## 🎯 What is ChipOS?

ChipOS is a **microservices-based engine** that provides AI coding assistants with access to your documentation, project knowledge, and task management through the Model Context Protocol (MCP). The platform consists of four main services that work together to deliver comprehensive knowledge management and project automation.

## 🏗️ Architecture Overview

### Microservices Structure

ChipOS uses true microservices architecture with clear separation of concerns:
...
| -------------- | -------------------- | ---------------------------- | -------------------------------------------------------------------------- |
| **Frontend**   | `chipos-ui-main/`    | Web interface and dashboard  | React, TypeScript, TailwindCSS, Socket.IO client                           |
...
There are a few very important rules that we ask you follow when contributing to ChipOS.
...
**1. Check the list of PRs** to make sure you aren't about to fix or implement something that's already been done! Also be sure to check the [ChipOS Kanban board](https://github.com/users/coleam00/projects/1) where the maintainers are manage issues/features.
...
Make sure the crawling completes end to end, the code examples exist, and the ChipOS MCP can be used to successfully search through the documentation.
...
Test these things using both the UI and the MCP server. This process will be similar if your code changes touch the docs part of ChipOS too.

**7. If your code changes touch the MCP server instructions or anything else more high level** that could affect how AI coding assistants use the ChipOS MCP, please retest by creating a simple project from scratch that leverages ChipOS for RAG, task management, etc.
...
1. **Fork the Repository**
   - Go to https://github.com/coleam00/chipos
   - Click the "Fork" button in the top right corner
   - This creates your own copy of the repository

   ```bash
   # Clone your fork (replace 'your-username' with your GitHub username)
   git clone https://github.com/your-username/chipos.git
   cd chipos

   # Add upstream remote to sync with main repository later
   git remote add upstream https://github.com/coleam00/chipos.git
   ```

2. **🤖 AI Coding Assistant Setup**

   **IMPORTANT**: If you're using AI coding assistants to help contribute to ChipOS, set up our global rules for optimal results.
   ...
   These rules contain essential context about ChipOS's architecture, service patterns, MCP implementation, and development best practices. Using them will help your AI assistant follow our conventions and implement features correctly.
...
2. **Create Pull Request via GitHub UI**
   - Go to your fork on GitHub (https://github.com/your-username/chipos)
...
3. **Testing Requirements**
   ...
   **Test commands:**
   ...
   cd chipos-ui-main && npm run test   # Frontend tests
...
- **Components**: `chipos-ui-main/src/components/` - Reusable UI components organized by feature
- **Pages**: `chipos-ui-main/src/pages/` - Main application routes
- **Services**: `chipos-ui-main/src/services/` - API communication and business logic
- **Contexts**: `chipos-ui-main/src/contexts/` - React context providers for global state
...
1. **Adding a New Component**
   ...
   chipos-ui-main/src/components/your-category/YourComponent.tsx

   # Add to appropriate page or parent component
   chipos-ui-main/src/pages/YourPage.tsx
   ```
...
2. **Testing Your Changes**
   ...
   # Or manually
   cd chipos-ui-main && npm run test
...
**Ready to contribute?** Start by exploring the codebase, reading the architecture documentation, and finding an area that interests you. Every contribution makes ChipOS better for the entire AI development community.
