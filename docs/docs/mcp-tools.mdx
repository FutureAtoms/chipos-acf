...
<div className="hero hero--secondary">
  <div className="container">
    <h2 className="hero__subtitle">
      Complete reference for all 14 MCP tools available in ChipOS, with parameters, return types, and usage examples.
    </h2>
  </div>
</div>
...
ChipOS provides 14 MCP tools organized into three categories:
...
| `assignee` | `string` | ❌ | User/ChipOS/AI IDE Agent |
