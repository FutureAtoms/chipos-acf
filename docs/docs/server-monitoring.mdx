...
<div className="hero hero--primary">
  <div className="container">
    <h2 className="hero__subtitle">
      **Monitor your ChipOS services**: Health checks, performance metrics, and troubleshooting tools
    </h2>
  </div>
</div>

ChipOS provides built-in monitoring and health checking across all services to help you maintain optimal performance and quickly troubleshoot issues.
...
Monitor the status of all ChipOS services:
...
ChipOS tracks important performance metrics:
...
Use the health endpoints and browser developer tools to quickly diagnose issues with your ChipOS installation.
</Admonition>
...
docker-compose logs -f chipos-mcp
```
...
API_BASE_URL=http://chipos-server:8080
```

### Unified Logging System

ChipOS includes a unified logging system with optional [Logfire](https://logfire.pydantic.dev/) integration:
...
ChipOS automatically manages resources:
