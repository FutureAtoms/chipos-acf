---
title: ChipOS Projects Features
sidebar_position: 2
---
...
# 📊 ChipOS Projects: Complete Feature Reference

<div className="hero hero--secondary">
  <div className="container">
    <h2 className="hero__subtitle">
      Everything you can do with ChipOS Projects - from simple task tracking to complex project orchestration with AI assistance.
    </h2>
  </div>
</div>
...
- **Task Assignment**: Assign to User, ChipOS, or AI IDE Agent
