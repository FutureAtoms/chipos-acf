...
This guide explains how to configure and optimize the ChipOS crawling system powered by Crawl4AI.

## Overview

ChipOS uses [Crawl4AI](https://github.com/unclecode/crawl4ai) for web crawling, which provides powerful features for extracting content from various types of websites. The system automatically detects content types and applies appropriate crawling strategies.
