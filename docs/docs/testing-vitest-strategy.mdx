...
This document outlines ChipOS's comprehensive frontend testing strategy using Vitest with React and TypeScript, incorporating the latest best practices and our current implementation.
...
ChipOS includes a sophisticated UI test runner accessible from the Settings page:
  ...
  test:
    ...
    - name: Setup Node.js
      ...
      with:
        node-version: '20'
        cache: 'npm'
        cache-dependency-path: chipos-ui-main/package-lock.json
    
    - name: Install dependencies
      working-directory: ./chipos-ui-main
      run: npm ci
    ...
    - name: Upload coverage reports
      ...
      with:
        file: ./chipos-ui-main/coverage/coverage-final.json
        flags: frontend
