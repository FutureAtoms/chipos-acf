---
title: ChipOS Projects Overview
sidebar_position: 1
---
...
# 📊 ChipOS Projects: AI-Powered Project Management
...
ChipOS Projects brings intelligent project management to your AI development workflow. Your AI assistants can understand project context, create and update tasks, manage documentation, and help you stay organized while you code.

## 🎯 Overview

The ChipOS task management system provides:
...
ChipOS uses a simple but flexible data structure:
...
1. **Open ChipOS**: Navigate to http://localhost:3737
...
3. **Fill Details**:
   ...
   - **Assignee**: Choose from User, ChipOS, or AI IDE Agent
...
When creating projects, ChipOS automatically generates a structured PRD:
...
ChipOS provides built-in progress tracking:
