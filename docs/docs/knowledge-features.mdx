---
title: ChipOS Knowledge Features
sidebar_position: 2
---
...
# 🧠 ChipOS Knowledge: Complete Feature Reference

<div className="hero hero--secondary">
  <div className="container">
    <h2 className="hero__subtitle">
      Everything you can do with ChipOS Knowledge - from web crawling to semantic search, document processing to code extraction.
    </h2>
  </div>
</div>
