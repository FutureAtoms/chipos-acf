      ...
      >
        ...
        >
          <div className="relative w-10 h-10">
            {/* Subtle cyan glow */}
            <div className="absolute inset-0 rounded-xl bg-[#00d9ff]/20 blur-lg opacity-75" />

            {/* Icon container with glass effect */}
            <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-white/[0.15] to-white/[0.08] backdrop-blur-xl border border-white/20 flex items-center justify-center">
            ...
            >
              <div className="space-y-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Found a bug or issue? Report it to help improve ChipOS Beta.
                </p>
