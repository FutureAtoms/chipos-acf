...
import { Search, Grid, Plus, Filter, BoxIcon, List, BookOpen, CheckSquare, Brain, Database, Zap } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { MagicCard } from '../features/ui/magic/magic-card';
import { MagicButton } from '../features/ui/magic/magic-button';
import { MagicInput } from '../features/ui/magic/magic-input';
...
import { AnimatedCounter } from '../features/ui/magic/number-ticker';
      ...
      >
        ...
        <motion.div className="flex items-center gap-4" variants={headerItemVariants}>
          ...
          <MagicButton
            ...
            className={isSelectionMode ? "bg-[#00d9ff]/10 border-[#00d9ff]/40" : ""}
          >
      ...
      <AnimatePresence>
        {isSelectionMode && selectedItems.size > 0 && (
          <motion.div
            ...
            className="mb-6"
          >
            <MagicCard className="p-4" gradientColor="#00d9ff" showBorderBeam={true} beamDuration={12}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <span className="text-sm font-medium text-white">
                    {selectedItems.size} item{selectedItems.size > 1 ? 's' : ''} selected
                  </span>
                  <MagicButton onClick={selectAll} variant="ghost" size="sm">
                    Select All
                  </MagicButton>
                  <MagicButton onClick={deselectAll} variant="ghost" size="sm">
                    Clear Selection
                  </MagicButton>
                </div>
                <div className="flex items-center gap-2">
                  <MagicButton onClick={() => setIsGroupModalOpen(true)} variant="outline" size="sm">
                    Create Group
                  </MagicButton>
                  <MagicButton onClick={deleteSelectedItems} variant="glow" size="sm">
                    Delete Selected
                  </MagicButton>
                </div>
              </div>
