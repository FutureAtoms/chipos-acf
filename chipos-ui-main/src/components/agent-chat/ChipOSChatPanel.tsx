...
import { ChipOSLoadingSpinner, EdgeLitEffect } from "../animations/Animations";
import { agentChatService, ChatMessage } from "../../services/agentChatService";

/**
 * Props for the ChipOSChatPanel component
 */
interface ChipOSChatPanelProps {
  "data-id"?: string;
}
/**
 * ChipOSChatPanel - A chat interface for the ChipOS AI assistant
 *
 ...
 */
export const ChipOSChatPanel: React.FC<ChipOSChatPanelProps> = (props) => {
  ...
  useEffect(() => {
    return () => {
      if (sessionIdRef.current) {
        console.log(
          "[CHAT PANEL] Component unmounting, cleaning up session:",
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-zinc-800/80">
          <div className="flex flex-col gap-2">
            <div className="flex items-center">
              {/* ChipOS Logo - No animation in header */}
