...
export const IDEGlobalRules = () => {
  ...
  const claudeRules = `# CRITICAL: CHIPOS-FIRST RULE - READ THIS FIRST
...
- [ ] Documentation updated if needed`;
  ...
  const universalRules = `# ChipOS Integration & Workflow
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-start">
          <p className="text-sm text-gray-600 dark:text-zinc-400 w-4/5">
            Add global rules to your AI assistant to ensure consistent ChipOS workflow integration.
          </p>
          <Button 
            variant="outline" 
            accentColor="blue" 
        ...
        <fieldset className="flex items-center space-x-6">
          ...
          <label className="flex items-center cursor-pointer">
            <input
              ...
              aria-label="Claude Code Rules - Comprehensive ChipOS workflow instructions for Claude"
            />
