...
/**
 * ChipOSLoadingSpinner - A loading animation component with neon trail effects
 *
 * This component displays the ChipOS logo with animated spinning circles
 ...
 */
export const ChipOSLoadingSpinner: React.FC<{
  size?: "sm" | "md" | "lg";
  logoSrc?: string;
  className?: string;
}> = ({ size = "md", logoSrc = "/logo-neon.png", className = "" }) => {
