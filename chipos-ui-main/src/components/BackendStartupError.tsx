            ...
            <div className="space-y-4 flex-1">
              ...
              <div className="bg-black/50 rounded-lg p-4 border border-red-900/50">
                ...
                <p className="text-red-100 font-mono text-sm mb-3">
                  Check the <span className="text-red-400 font-bold">ChipOS API server</span> container logs in Docker Desktop for detailed error information.
                </p>
                <div className="space-y-2 text-xs text-red-300">
                  <p>1. Open Docker Desktop</p>
                  <p>2. Go to Containers tab</p>
                  <p>3. Look for the ChipOS server container (typically named <span className="text-red-400 font-semibold">chipos-server</span> or similar)</p>
