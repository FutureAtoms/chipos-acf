      ...
      >
        ...
        <div
          className={cn(
            ...
            "rounded-2xl px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#00d9ff1f]",
            // transition
            "transform-gpu transition-all duration-300 ease-in-out",
            // on hover
            "group-hover:shadow-[inset_0_-6px_10px_#00d9ff3f]",
            // on click
            "group-active:shadow-[inset_0_-10px_10px_#00d9ff3f]"
          )}
        />
