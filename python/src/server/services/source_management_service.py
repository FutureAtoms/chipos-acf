...
async def update_source_info(
    ...
    try:
        ...
        existing_source = (
            client.table("chipos_sources").select("title").eq("source_id", source_id).execute()
        )
        ...
        if existing_source.data:
            ...
            client.table("chipos_sources").upsert(upsert_data).execute()
...
class SourceManagementService:
    ...
    def get_available_sources(self) -> tuple[bool, dict[str, Any]]:
        ...
        """
        try:
            response = self.supabase_client.table("chipos_sources").select("*").execute()
    ...
    def delete_source(self, source_id: str) -> tuple[bool, dict[str, Any]]:
        ...
        try:
            ...
            try:
                ...
                pages_response = (
                    self.supabase_client.table("chipos_crawled_pages")
                    .delete()
                    .eq("source_id", source_id)
                    .execute()
                )
            ...
            try:
                ...
                code_response = (
                    self.supabase_client.table("chipos_code_examples")
                    .delete()
                    .eq("source_id", source_id)
                    .execute()
                )
            ...
            try:
                ...
                source_response = (
                    self.supabase_client.table("chipos_sources")
                    .delete()
                    .eq("source_id", source_id)
                    .execute()
                )
    ...
    def list_sources_by_type(self, knowledge_type: str = None) -> tuple[bool, dict[str, Any]]:
        ...
        """
        try:
            query = self.supabase_client.table("chipos_sources").select("*")
