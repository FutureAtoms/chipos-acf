...
class CredentialService:
    ...
    async def load_all_credentials(self) -> dict[str, Any]:
        ...
        try:
            ...
            result = supabase.table("chipos_settings").select("*").execute()
    ...
    async def set_credential(
        ...
        try:
            ...
            supabase.table("chipos_settings").upsert(
                data,
    ...
    async def delete_credential(self, key: str) -> bool:
        ...
        try:
            ...
            supabase.table("chipos_settings").delete().eq("key", key).execute()
    ...
    async def get_credentials_by_category(self, category: str) -> dict[str, Any]:
        ...
        try:
            supabase = self._get_supabase_client()
            result = (
                supabase.table("chipos_settings").select("*").eq("category", category).execute()
            )
