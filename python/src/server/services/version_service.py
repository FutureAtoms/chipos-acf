...
from ..config.version import CHIPOS_VERSION, GITHUB_REPO_NAME, GITHUB_REPO_OWNER
from ..utils.semantic_version import is_newer_version


class VersionService:
    """Service for checking ChipOS version against GitHub releases."""
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                response = await client.get(
                    ...
                    headers={
                        ...
                        "User-Agent": f"ChipOS/{CHIPOS_VERSION}",
                    },
                )
    ...
    async def check_for_updates(self) -> dict[str, Any]:
        """
        Check if a newer version of ChipOS is available.
        ...
        try:
            ...
            update_available = is_newer_version(CHIPOS_VERSION, latest_version)
